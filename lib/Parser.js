...
var LASTPLAYTIME_PATTERN = /\01lastplaytime\00(.*?)\00/i;
...
var parseShortcut = function (shortcutAsString) {
  ...
  var LastPlayTime = LASTPLAYTIME_PATTERN.exec(shortcutAsString);
  ...
  return {
    ...
    LastPlayTime: LastPlayTime ? LastPlayTime[1] === "\01" : false,
